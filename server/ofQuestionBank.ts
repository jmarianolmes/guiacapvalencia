...
export async function importOfQuestionBank(fileName = 'of_cap_objetivo_1_1.json') {
  ...
  if (!['of_cap_objetivo_1_1.json', 'of_cap_objetivo_1_2.json', 'of_cap_objetivo_1_3.json', 'of_cap_objetivo_1_3_bis.json', 'of_cap_objetivo_1_4.json', 'of_cap_objetivo_2_1.json', 'of_cap_objetivo_2_2.json', 'of_cap_objetivo_3_1.json', 'of_cap_objetivo_3_2.json', 'of_cap_objetivo_3_3.json', 'of_cap_objetivo_3_4.json', 'of_cap_objetivo_3_5.json', 'of_cap_objetivo_3_6.json', 'of_cap_objetivo_3_7.json'].includes(fileName)) throw new Error('Arquivo OF não autorizado nesta carga.');

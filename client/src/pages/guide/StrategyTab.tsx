...
export default function StrategyTab({ language }: StrategyTabProps) {
  ...
  const t = {
    pt: {
      ...
      tip3_desc: 'Você tem 2 horas. Dedique 1h30 às questões e 30 min para revisar.', personalTitle: 'Minha estratégia baseada no meu histórico', personalLoading: 'Analisando seu histórico...', personalEmpty: 'Entre na sua conta e conclua provas oficiais completas de 100 questões para receber uma recomendação personalizada.', averageOfficial: 'média de acertos por prova oficial', accuracy: 'taxa de acerto nas provas oficiais', recurring: 'erros recorrentes oficiais', safe: 'conhecimento efetivo observado', rule: 'Regra usada: com +1 por acerto e −0,5 por erro, responder entre duas alternativas tende a ser vantajoso; chutar sem saber entre quatro tende a reduzir a pontuação.', basedOnly: 'A estatística usa apenas provas oficiais completas de 100 questões.',
    },
    es: {
      ...
      tip3_desc: 'Tienes 2 horas. Dedica 1h30 a las preguntas y 30 min para revisar.', personalTitle: 'Mi estrategia basada en mi historial', personalLoading: 'Analizando tu historial...', personalEmpty: 'Inicia sesión y completa exámenes oficiales completos de 100 preguntas para recibir una recomendación personalizada.', averageOfficial: 'media de aciertos por examen oficial', accuracy: 'tasa de acierto en exámenes oficiales', recurring: 'errores recurrentes oficiales', safe: 'conocimiento efectivo observado', rule: 'Regla usada: con +1 por acierto y −0,5 por error, responder entre dos alternativas suele ser ventajoso; adivinar entre cuatro sin saber suele reducir la puntuación.', basedOnly: 'La estadística usa solo exámenes oficiales completos de 100 preguntas.',
    },
  };
